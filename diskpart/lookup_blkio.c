 ...
 */
/*
 * An alternative interface to diskpart_lookup_bsd_compat that takes a
 * oskit_blkio_t and returns another.
...
struct diskpart *
diskpart_blkio_lookup_bsd_compat(struct diskpart *array,
				 ...
				 oskit_blkio_t **out_b)
{
	...
	dp = diskpart_lookup_bsd_compat(array, slice, part);
	if (dp == NULL)
		return NULL;
