 ...
 */
/*
 *  Timer support specific to arm32/shark programmable interval timer
 *  This header file contains all parameters
 */

#ifndef _DEV_ARM32_PIT_PARAM_H_
#define _DEV_ARM32_PIT_PARAM_H_
