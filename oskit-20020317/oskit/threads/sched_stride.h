...
#ifndef	_OSKIT_THREADS_SCHED_STRIDE_H_
#define _OSKIT_THREADS_SCHED_STRIDE_H_
 ...
 */
extern int __drag_in_stride_scheduler__;
int *__using_stride_scheduler__ = &__drag_in_stride_scheduler__;

#endif  /* _OSKIT_THREADS_SCHED_STRIDE_H_ */
