 ...
 * `oskit_mib_tcp' COM interface.
 */
#ifndef _OSKIT_FREEBSD_NET_BSDNET_MIB_TCP_H
#define _OSKIT_FREEBSD_NET_BSDNET_MIB_TCP_H
...
#endif /* _OSKIT_FREEBSD_NET_BSDNET_MIB_TCP_H */
