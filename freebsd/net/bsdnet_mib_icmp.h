 ...
 * `oskit_mib_icmp' COM interface.
 */
#ifndef _OSKIT_FREEBSD_NET_BSDNET_MIB_ICMP_H
#define _OSKIT_FREEBSD_NET_BSDNET_MIB_ICMP_H
...
#endif /* _OSKIT_FREEBSD_NET_BSDNET_MIB_ICMP_H */
