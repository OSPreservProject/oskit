 ...
 */
#ifndef _OSKIT_ARM32_SHARK_BASE_MULTIBOOT_H_
#define _OSKIT_ARM32_SHARK_BASE_MULTIBOOT_H_
 ...
 */
void multiboot_main(void *ofw_handle, oskit_addr_t boot_info_pa);
...
#endif /* _OSKIT_ARM32_SHARK_BASE_MULTIBOOT_H_ */
